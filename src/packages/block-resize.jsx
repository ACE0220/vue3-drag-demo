...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        const onmousemove = (e) => {
            ...
            if(direction.horizontal == 'center') { // 如果拖拽的是纵向的点，横向不能变化
                clientX = startX;
            }
            if(direction.vertical == 'center') { // 如果拖拽的是横向的点，纵向不能发生变化
                clientY = startY;
            }
            ...
            props.block.height = height; // 拖拽的时候改变宽高
